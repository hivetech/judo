...
func (params *sharedSignatureParams) composeSharedSignature() string {
    ...
    signature := sign(params.accountKey, stringToSign)
    return signature
}
...
// http://msdn.microsoft.com/en-us/library/windowsazure/dn140255.aspx
func (params *sharedSignatureParams) composeAccessQueryValues() url.Values {
...
func getReadBlobAccessValues(container, filename, accountName, accountKey string, expires time.Time) url.Values {
